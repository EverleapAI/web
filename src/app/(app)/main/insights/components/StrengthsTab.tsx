  ...
  return (
    ...
    <section className="mb-6 space-y-3">
      ...
      <InsightsSummaryCard
        ...
        pageKey="insights_strengths"
        eyebrow="Insights · Strengths"
      />

      {afterAgentic}

      {lowSignal ? (
        <InsightsUnlockCTA variant="low" dark={dark} category="Strengths" href={STORY_HREF} />
      ) : partialSignal ? (
        <InsightsUnlockCTA variant="partial" dark={dark} category="Strengths" href={STORY_HREF} />
      ) : null}
