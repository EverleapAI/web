...
export default function InsightsIntroPage() {
            ...
            <div className={`w-full rounded-3xl border px-6 py-7 md:px-8 md:py-8 ${cardSurface}`}>
              <div className="mx-auto max-w-xl text-center">
                ...
                <p className="mt-3 text-sm leading-relaxed text-slate-200/85 md:text-base">
                  Insights is where Everleap starts connecting patterns. You’ll see early signals, recommendations,
                  and “why this fits you” explanations. Over time, the insights become more accurate as the app learns
                  from your answers and actions.
                </p>
                ...
                <div className="mt-6 rounded-2xl border border-white/10 bg-slate-950/35 px-5 py-4 text-left">
                  ...
                  <ul className="mt-2 space-y-2 text-sm text-slate-200/80">
                    <li>• Pattern snapshots (light, not overwhelming)</li>
                    <li>• Recommendations (with “dive deeper” paths)</li>
                    <li>• Confidence indicators (how sure Everleap is)</li>
                    <li>• Gentle prompts to validate or correct the model</li>
                  </ul>
                </div>
