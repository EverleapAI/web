...
import { Users, HeartHandshake, ChevronRight, Bookmark, ArrowUpRight } from "lucide-react";
...
export default function CommunityRenderer({ chip, dark }: ExploreRendererProps) {
  ...
  return (
    <div className="space-y-3">
        ...
        <div className={`rounded-3xl border p-4 ${shell}`}>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {area.signals.map((s) => (
              ...
              >
                <HeartHandshake className="h-3.5 w-3.5 opacity-70" />
                {s}
              </span>
            ))}
          </div>
      ...
      {/* Next moves become “get involved” */}
