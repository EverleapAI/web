...
/* =============================================================================
   Explore › TravelRenderer (Education-style mechanics)
   ...
   - Distinct marker: emoji-only pill (NO “Path”, NO #1-4)
============================================================================= */
...
function toRecFromTravelCard(
  ...
  return {
    ...
    why: signals.length ? signals.slice(0, 3) : ["A travel experiment that matches your vibe."],
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="min-w-0">
                            <div className="flex items-center gap-2">
                              {/* Emoji-only marker pill (NO “Path”) */}
                              <span
                            ...
                            {expanded ? (
                              <div className={`mt-3 text-xs font-semibold ${dark ? "text-white/55" : "text-slate-600"}`}>
                                Tap to close
                              </div>
                            ) : null}
                          </div>
                          ...
                          >
                            {!expanded ? (
                              <span className="relative h-full w-full">
                                ...
                                />
                                <span className={`absolute inset-0 ${dark ? "bg-slate-950/20" : "bg-white/20"}`} />
                                <span
                      ...
                      {expanded ? (
                        <div className="mt-4 lg:mt-5">
                          ...
                          <div className="mt-4 lg:mt-5">
                            ...
                            >
                              {/* NO extra left rail (avoid double-rail collision) */}
                              <div
