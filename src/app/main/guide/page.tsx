            ...
            <div className={`w-full rounded-3xl border px-6 py-7 md:px-8 md:py-8 ${cardSurface}`}>
              <div className="mx-auto max-w-xl text-center">
                ...
                <p className="mt-3 text-sm leading-relaxed text-slate-200/85 md:text-base">
                  This is your Everleap Guide — the place where the app talks back. It will help you reflect,
                  connect the dots across your answers, and suggest next steps you can actually do this week.
                </p>

                <div className="mt-6 rounded-2xl border border-white/10 bg-slate-950/35 px-5 py-4 text-left">
                  <div className="text-sm font-semibold text-slate-100">What the Guide will do</div>
                ...
                <div className="mt-6 text-xs text-slate-200/60">
                  (Profile + settings will live in the “+” menu — separate from this space.)
                </div>
              </div>
            </div>
          </div>
