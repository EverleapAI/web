...
if (!RAW_BASE) throw new Error("Missing NEXT_PUBLIC_API_BASE_URL for /api/guidance/ladder proxy.");
const API_BASE = /\/api$/i.test(RAW_BASE) ? RAW_BASE : `${RAW_BASE}/api`;
const TARGET_URL = `${API_BASE}/guidance/ladder`;
...
export async function GET(req: NextRequest) {
  ...
  // A career's shape doesn't change day to day.
