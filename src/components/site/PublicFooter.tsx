// src/components/site/PublicFooter.tsx
"use client";
...
export default function PublicFooter() {
  return (
    <nav className="fixed inset-x-0 bottom-0 z-20 flex items-center justify-between border-t border-white/10 bg-slate-950/70 px-4 py-3 text-xs text-slate-400 backdrop-blur-xl md:px-8">
      <div className="font-medium tracking-wide text-slate-300">Everleap</div>
      ...
      <div className="flex items-center gap-4">
        ...
        <Link href="/accessibility" className="transition hover:text-slate-200">
          Accessibility
        </Link>
      </div>
    </nav>
